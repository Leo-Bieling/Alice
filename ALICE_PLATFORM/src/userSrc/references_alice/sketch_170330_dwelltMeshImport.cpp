...
void draw()
{
	...
	if (plotOnOff) plot.draw(true); //PLOT
	vec plotBoundingBoxMax;
	vec plotBoundingBoxMin;
	plot.boundingBox(plotBoundingBoxMin, plotBoundingBoxMax);
	plotA = plotBoundingBoxMin;
	plotB = vec(plotBoundingBoxMin.x, plotBoundingBoxMax.y, 0);
	plotC = plotBoundingBoxMax;
	plotD = vec(plotBoundingBoxMax.x, plotBoundingBoxMin.y, 0);
