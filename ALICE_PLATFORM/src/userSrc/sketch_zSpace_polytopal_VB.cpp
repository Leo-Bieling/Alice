...
string dirPath = "C:/Users/Leo.b/Desktop/graph/primal";
//string dirPath = "C:/Users/Leo.b/Desktop/graph/primal";
vector<string> forceFiles;

string exportPath = "C:/Users/Leo.b/Desktop/graph/primal/polytopals/";
...
void setup()
{
	...
	for (auto fp: forceFiles) cout << endl << fp;
...
void draw()
{
	...
	glColor3f(0, 1, 0);
	for (zItGraphEdge e(*myPolytopal.formObj); !e.end(); e++)
	{
		/*zVector v0 = e.getHalfEdge(0).getStartVertex().get();
		zVector v1 = e.getHalfEdge(0).getVertex().getVertexPosition();;

		zVector pos = (v0 + v1) * 0.5;*/
		drawTextAtVec(to_string(e.getId()), e.getCenter());
	}
