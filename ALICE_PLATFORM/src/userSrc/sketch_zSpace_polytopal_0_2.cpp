...
{	
	...
	{
		zMesh tmpMesh;
		fromOBJ(tmpMesh, ("C:/Users/Leo.b/source/repos/Alice2018_zSpace/ALICE_PLATFORM/x64/Release/EXE/data/app_polytopal/mesh_" + to_string(i) + ".obj"));
	...
	B.addButton(&drawvolumeForceMeshes, "Operate on meshes");
